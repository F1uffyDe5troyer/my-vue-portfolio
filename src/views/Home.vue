...
label input:checked + .menu {
  box-shadow: 0 0 0 100vw rgb(255, 255, 255), 0 0 0 100vh #FFF;
  border-radius: 0;
}
...
label .menu {
  ...
  -webkit-transition: .5s ease-in-out;
  transition: .5s ease-in-out;
  box-shadow: 0 0 0 0 crimson, 0 0 0 0 #FFF;
  cursor: pointer;
}
...
.about, .services, .skills, .teams, .contact,footer, .WorkEducation{
...
.WorkEducation .title::after{
    content: "my journey";
    background-color: #111;
}

.WorkEducation .title::before{
    background: rgb(255, 255, 255);
}
...
.timeline{
  ...
  background: -webkit-linear-gradient(left, rgb(255, 255, 255) 0%,rgb(255, 255, 255) 60%,rgb(255, 255, 255) 100%);
  ...
  .timeline-month:before{
    ...
    height:20px;
  background: crimson;
  background: -moz-linear-gradient(top, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 60%, rgb(255, 255, 255) 100%);
  background: -webkit-linear-gradient(top, rgb(255, 255, 255) 0%,rgb(255, 255, 255) 60%,rgb(255, 255, 255) 100%);
  background: linear-gradient(to bottom, rgb(255, 255, 255) 0%,rgb(255, 255, 255) 60%,rgb(255, 255, 255) 100%);
  ...
  .timeline-section:after{
    ...
    width:10px;
    height:10px;
    background:linear-gradient(to bottom, rgb(255, 255, 255) 0%,rgba(122,130,136,1) 60%,rgba(112,120,125,1) 100%);
    top:7px;
    left:11px;
